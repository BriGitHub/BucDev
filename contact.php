...
<div class="container"> 
	<div class="row">
		<div class=" col-sm-12 col-md-6 col-lg-6">
			<!-- your code for the left column goes here -->
			<p><strong>Phone:</strong> (423) 475-6105</p>
			<p><strong>Address:</strong> 5809 Ringgold Rd, East Ridge, TN 37412</p>
			<p><strong>Office Hours:</strong> M-F 8:00AM - 5:00PM
			<!-- Map -->
			<div class="mapouter"><div class="gmap_canvas"><iframe width="350" height="250" id="gmap_canvas" src="https://maps.google.com/maps?q=5809%20Ringgold%20Rd%2C%20East%20Ridge%2C%20TN%2037412&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://www.embedgooglemap.net">embedgooglemap.net</a></div><style>.mapouter{position:relative;text-align:right;height:250px;width:350px;}.gmap_canvas {overflow:hidden;background:none!important;height:250px;width:350px;}</style></div>
		</div>
		<div class=" col-sm-12 col-md-6 col-lg-6">
			
			<form class="form-horizontal" style="    background: #606060;
    padding: 30px 25px;
    color: white;">
<fieldset>

<!-- Form Name -->
	<legend>Have questions? <br> Fill out the form below!</legend>
	...
	<!-- Text input-->
	<div class="form-group">
	  <label class="c control-label" for="textinput">Last Name:</label>  
	  <div class="">
	...
	<div><a class="button2" href="">Submit</a></div>
	</fieldset>
	</form>
		   </div>
		</div>
...
<style>
	footer.foot { padding:20px; text-align:center;
 bottom: 0;
 width: 100%;}

</style>
<footer class="foot">
	J and J Quality Auto Service Copyright &copy; 2018 
</footer>
</body>
</html>
